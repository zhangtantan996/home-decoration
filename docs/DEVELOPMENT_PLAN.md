...
> **2026-04 阶段更新说明**: 本文档形成于旧的 Web-first / 模拟支付阶段，当前仅作为历史参考。  
> 当前试运营整体计划请优先使用 [试运营整体开发计划_2026-04.md](./试运营整体开发计划_2026-04.md)。  
> 若与 [产品需求文档(PRD).md](./产品需求文档(PRD).md) v2.1、[BUSINESS_FLOW.md](./BUSINESS_FLOW.md) 或 2026-04 商业运营文档冲突，统一以后者为准。
