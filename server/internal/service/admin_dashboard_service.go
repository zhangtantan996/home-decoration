...
func (s *AdminDashboardService) GetOverview() (*DashboardOverview, error) {
	...
	overview := &DashboardOverview{
		...
		DashboardSections: []DashboardSectionSummary{
			...
			{Key: "supply", Title: "服务商质量看板", Metrics: []DashboardMetricValue{{Key: "provider_count", Label: "服务商数", Value: float64(providerCount)}, {Key: "support_tier", Label: "重点扶持商家", Value: providerTierCounts["重点扶持期"]}}},
