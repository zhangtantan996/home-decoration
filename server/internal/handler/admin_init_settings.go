...
func AdminInitSettings(c *gin.Context) {
	...
	settings := []model.SystemSettings{
		// 基本设置
		{Key: "site_name", Value: "家装管理平台", Description: "网站名称", Category: "basic"},
		{Key: "site_description", Value: "专业的家装服务管理系统", Description: "网站描述", Category: "basic"},
		{Key: "contact_email", Value: "support@example.com", Description: "联系邮箱", Category: "basic"},
		{Key: "contact_phone", Value: "400-888-8888", Description: "联系电话", Category: "basic"},
		{Key: "icp", Value: "京ICP备12345678号", Description: "ICP备案号", Category: "basic"},
		// 功能开关
		...
		{Key: "wechat_api_key", Value: "", Description: "微信支付API密钥", Category: "payment"},
		// 支付宝配置
		{Key: "alipay_app_id", Value: "", Description: "支付宝AppID", Category: "payment"},
		{Key: "alipay_private_key", Value: "", Description: "支付宝应用私钥", Category: "payment"},
		{Key: "alipay_public_key", Value: "", Description: "支付宝公钥", Category: "payment"},
		// 短信配置
		{Key: "sms_provider", Value: "", Description: "短信服务商", Category: "sms"},
		{Key: "sms_access_key", Value: "", Description: "短信服务AccessKey", Category: "sms"},
		{Key: "sms_secret_key", Value: "", Description: "短信服务SecretKey", Category: "sms"},
		...
		{Key: "im_tencent_secret_key", Value: "", Description: "腾讯云IM SecretKey", Category: "im"},
	}
